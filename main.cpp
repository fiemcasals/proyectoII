...
public:
    ...
    void realizarMvimiento(Mapa & mapa,Gato &tom,Raton &aux){//efectuo el desplazamiento de del gato
        ...
        if(tom.meConvieneCazar(modulo,aux.getPeso()))//en caso de que se devuelva true de la funcion booleana se efectua la caza
        {
    ...
    void gestion(){
        ...
        Raton raton1(20.0,0,0);//creo 7 objetos del tipo raton
        Raton raton2(10.0,1,7);
        Raton raton3(4.0,3,3);
        Raton raton4(15.0,6,2);
        Raton raton5(11.0,7,8);
        Raton raton6(8.0,8,3);
        Raton raton7(12.0,9,9);
